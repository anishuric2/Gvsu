...
namespace Gvsu.Controllers
{
    public class CourseAssignmentsController : Controller
    {
        ...
        public CourseAssignmentsController(GvsuContext context)
        {
            _context = context;
        }
        ...
        {
            var gvsuContext = _context.CourseAssignments.Include(c => c.Course).Include(c => c.Instructor);
            return View(await gvsuContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("CourseAssignmentID,InstructorID,CourseID")] CourseAssignment courseAssignment)
        {
            ...
            ViewData["InstructorID"] = new SelectList(_context.Set<Instructor>(), "ID", "FirstMidName", courseAssignment.InstructorID);
            return View(courseAssignment);
        }
